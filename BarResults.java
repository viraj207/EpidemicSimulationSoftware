 ...
 * @author eboat
 */
public class BarResults extends JPanel {
...
//    }
    ...
    private void setData(int healthy, int recovered, int infected, int dead, int spread_rate, int day) {
    ...
    public void paint(Graphics g) {
        ...
        drawBars(g2d, this.healthy, this.recovered, this.infected, this.dead, 100);
        ...
        drawTextAR(g2d, "Day: " + this.day, 800, 45 + (30 * 3), Color.BLACK);
